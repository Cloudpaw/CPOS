...
file.write(handle)
file.close()
sr("https://raw.githubusercontent.com/Cloudpaw/CPOS/master/Computer/System/Applications/TextEdit.app/icon_l" "Computer/System/Applications/TextEdit.app/icon_l")
 local handle = download.readAll()
download.close()
